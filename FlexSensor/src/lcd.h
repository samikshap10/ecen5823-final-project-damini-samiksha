...
#define TIMER_HANDLE_1HZ   0x01   // Unique handle for the 1Hz timer
#define TIMER_INTERVAL_1HZ 32768  // 1 second in hardware clock ticks
#define TIMER_SLACK        500    // Allow some slack for power optimization
